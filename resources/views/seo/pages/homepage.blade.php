        ...
        <div class="mx-auto max-w-5xl space-y-6 px-4 sm:px-6 lg:px-8">
            ...
            <section class="bg-white p-6 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('seo.pages.homepage.update') }}" class="mt-6 grid gap-5 md:grid-cols-2">@csrf @method('PATCH')
                    ...
                    <div class="md:col-span-2"><x-input-label for="homepage_intro" value="Introduction" /><textarea id="homepage_intro" name="intro_content" data-markdown-editor rows="3" class="mt-1 block w-full rounded-md border-gray-300" required>{{ old('intro_content', $homepage->intro_content) }}</textarea></div>
                    ...
                    @endforeach
                    <div class="md:col-span-2"><x-input-label for="homepage_bottom_content" value="Bottom SEO content" /><textarea id="homepage_bottom_content" name="bottom_content" data-markdown-editor rows="10" class="mt-1 block w-full rounded-md border-gray-300">{{ old('bottom_content', $homepage->bottom_content) }}</textarea></div>
