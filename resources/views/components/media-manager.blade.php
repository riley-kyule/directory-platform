...
{{-- The mediaManager Alpine component is registered in resources/js/app.js via
     Alpine.data() — not an inline <script> here, which the app's CSP
     (script-src 'self', no 'unsafe-inline') silently blocks from running. --}}
