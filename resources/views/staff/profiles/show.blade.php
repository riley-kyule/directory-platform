                    ...
                    @if ($canOverrideRequirements)
                        <label class="block rounded-lg border border-red-200 bg-red-50 p-4 text-sm text-red-900">
                            <span class="flex items-start gap-3">
                                ...
                                <span><strong>Admin/CSR override</strong><br>Approve even if verification or reviewed-media requirements are missing. Missing verification checks will be marked verified as a permanent, attributable staff override recorded in the audit log.</span>
                            </span>
                        </label>
                    @endif
